...
mod imp {
    ...
    #[template(resource = "/com/example/frostnews/ui/category_pages/businessnews_page.ui")]
    pub struct BusinessNewsPage {
        #[template_child]
    ...
    impl ObjectSubclass for BusinessNewsPage {
        const NAME: &'static str = "BusinessNewsPage";
        type Type = super::BusinessNewsPage;
    ...
    impl ObjectImpl for BusinessNewsPage {
        fn constructed(&self) {
            self.parent_constructed();
        }
    }

    impl WidgetImpl for BusinessNewsPage {}
    impl NavigationPageImpl for BusinessNewsPage {}
}

glib::wrapper! {
    pub struct BusinessNewsPage(ObjectSubclass<imp::BusinessNewsPage>)
        @extends adw::NavigationPage, gtk::Widget,
        @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
}

impl BusinessNewsPage {
