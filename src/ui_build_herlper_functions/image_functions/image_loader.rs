...
use crate::{types::cache::ImageCache, widgets::blurred_image::BlurredBottomImage};
...
impl ImageLoader {
    ...
    // Image loading for BlurredBottomImage
    pub fn load_blurred_image(
        &self,
        image: &BlurredBottomImage,
        url: Option<String>,
        cache: ImageCache,
    ) {
        if let Some(url) = url {
